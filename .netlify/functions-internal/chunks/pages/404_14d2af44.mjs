...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(["", '<header class="header" data-astro-cid-3ef6ksr2><div class="logo-wrapper" data-astro-cid-3ef6ksr2><a href="/" class="nav-link" data-astro-cid-3ef6ksr2><img', ' alt="Brandon Martin" class="logo" data-astro-cid-3ef6ksr2><p class="white" data-astro-cid-3ef6ksr2>Brandon Martin</p></a></div><nav class="navigation" data-astro-cid-3ef6ksr2><ul data-astro-cid-3ef6ksr2><li data-astro-cid-3ef6ksr2><a href="/about" class="nav-link white" data-astro-cid-3ef6ksr2>/about</a></li><li data-astro-cid-3ef6ksr2><a href="/uses" class="nav-link white" data-astro-cid-3ef6ksr2>/uses</a></li><li data-astro-cid-3ef6ksr2><a href="/now" class="nav-link white" data-astro-cid-3ef6ksr2>/now</a></li></ul></nav><canvas class="background" data-astro-cid-3ef6ksr2></canvas><script', "><\/script><script>\n		const gradient = new Gradient();\n		gradient.initGradient('.background');\n	<\/script></header>"])), maybeRenderHead(), addAttribute(logo, "src"), addAttribute(miniGL, "src"));
