...
/* C:/Users/BMartin/Documents/GitHub/bpm-astro/src/components/SvelteCounter.svelte generated by Svelte v3.59.2 */
...
<div class="counter"><button>-</button>
	<pre>${escape(count)}</pre>
	<button>+</button></div>
<div class="counter-message">${slots.default ? slots.default({}) : ``}</div>`;
});
